...
| 37 | add-key label containment + help family | label `"prod-[REDACTED_OPENAI_KEY]"`; `help account` | label prints `[redacted]` (human AND `--json`); help lists refresh/auto-switch/remove/add-key |
